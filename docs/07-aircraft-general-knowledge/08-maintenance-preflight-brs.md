...
Art. 39 отдельно определяет источники [**директив лётной годности (English: airworthiness directive; español: directiva de aeronavegabilidad; AD)**](../reference/glossary.md#term-airworthiness-directive-ad): орган государства, отвечающего за типовую конструкцию; [EASA](../reference/glossary.md#term-easa) для применимых компонентов и оборудования; [AESA](../reference/glossary.md#term-aesa) для случаев в её компетенции. Art. 39.4 относится к требуемому корректирующему действию. Поэтому применимость AD ищут по типу, компоненту, оборудованию и указанию применимости (English: effectivity), а не по привычному названию двигателя или самолёта.

#### Документы и действительность лётной годности {#spanish-ulm-airworthiness-documents}

Испанское **ограниченное удостоверение лётной годности** (español: *certificado de aeronavegabilidad restringido*) по RD 141/2025 art. 30 выдаётся без заранее установленного срока окончания. Это не означает бессрочную пригодность самолёта к полёту. Удостоверение теряет действительность, если нарушено хотя бы одно применимое условие: самолёт больше не соответствует одобренной конструкции; не выполнены требования сохранения или проверки лётной годности либо применимые [AD](../reference/glossary.md#term-airworthiness-directive-ad); внесены неразрешённые модификация или ремонт; самолёт эксплуатировался за пределами ограничений [AFM](../reference/glossary.md#term-afm) без предусмотренных мер. Поэтому предполётная проверка отличает наличие документа от его текущей действительности. Источник: `SRC-BOE-RD-141-2025`, art. 30 (проверено 13.07.2026).

RD 182/2026 разрешил вести предусмотренные Ley 48/1960 бортовой журнал рейсов, журнал воздушного судна и журналы двигателя/винта в электронной форме, если обеспечены **доступность, удобство использования и надёжность** (English: accessibility, usability and reliability; español: accesibilidad, usabilidad y fiabilidad). Разрешённый электронный носитель не отменяет обязанность вести, сохранять и предъявлять применимые записи. Источник: `SRC-BOE-RD-182-2026`, artículo tercero, apartado seis — дополнительное положение 3 RD 765/2022 (проверено 13.07.2026).

Есть отдельная переходная граница для затронутых старых самолётов: ограниченные удостоверения, выданные до вступления RD 765/2022 и превышающие применимый предел массы пустого аппарата, сохраняются только в течение двух лет с 27.02.2025. После **27.02.2027** эксплуатация не приведённого в соответствие аппарата запрещена, кроме прямо предусмотренных ограничений [AD](../reference/glossary.md#term-airworthiness-directive-ad) или отдельного разрешения на полёт. Это не общий срок для каждого [ULM](../reference/glossary.md#term-ulm): владелец и пилот должны установить применимость по дате, массе и индивидуальным документам конкретного борта. Источник: `SRC-BOE-RD-141-2025`, переходное положение 1 (проверено 13.07.2026).
...
- Не принимайте бессрочно выданное ограниченное удостоверение за доказательство текущей лётной годности; проверяйте соответствие, обязательные действия, изменения, ограничения и записи.
- Для старого аппарата, потенциально затронутого переходным пределом массы, установите применимость даты 27.02.2027 до планирования его эксплуатации после этой даты.
...
6. «Если ограниченное удостоверение не имеет даты окончания, оно не может потерять действительность» — неверно.
7. «Электронный журнал освобождает от требований к содержанию и сохранению записей» — неверно.
...
### Q-AGK-041 — Что означает бессрочная выдача ограниченного удостоверения лётной годности [ULM](../reference/glossary.md#term-ulm)? {#q-agk-041}

A. Самолёт автоматически остаётся годным независимо от модификаций и обязательных действий.<br>
B. У документа нет заранее установленной даты окончания, но он теряет действительность при нарушении условий art. 30 RD 141/2025.<br>
C. Достаточно иметь фотографию документа без проверки записей.<br>
D. После выдачи [AD](../reference/glossary.md#term-airworthiness-directive-ad) больше не применяются.<br>

**Правильный ответ:** B.

**Почему:** Норма отдельно описывает бессрочную выдачу и события, прекращающие действительность; это две разные проверки.

**Почему главный отвлекающий вариант неверен:** A превращает административное отсутствие даты окончания в несуществующую гарантию технического состояния.

## Источники {#sources}

- `SRC-BOE-RD-141-2025` — art. 30, переходное положение 1 и Chapter V arts. 34–39; действительность ограниченного удостоверения, переход затронутых старых аппаратов, ответственность, компетентность, программа, проверка/документы и источники AD.
- `SRC-BOE-RD-182-2026` — разрешённая электронная форма бортовых журналов при доступности, удобстве использования и надёжности.
