...
| SRC-EURLEX-2024-2076 | EUR-Lex | Commission Implementing Regulation (EU) 2024/2076 | OJ от 25.07.2024; применимые положения с 14.08.2024 | 2026-07-13 | Изменения FCL.110.A, FCL.140.A, FCL.210.A, FCL.740.A и зачёт действующего экзамена LAPL для PPL той же категории; не создаёт автоматического зачёта ULM/MAF | <https://eur-lex.europa.eu/eli/reg_impl/2024/2076/oj/eng> |
