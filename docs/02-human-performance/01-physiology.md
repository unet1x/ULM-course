...
Правила Part-NCO и [Part-MED][part-med], встречающиеся в будущей подготовке, не переносятся автоматически на национальную эксплуатацию [ULM][ulm]. Здесь они служат консервативной подготовкой к следующей лицензии; применимое правило конкретного полёта устанавливается отдельно.
...
- `SRC-AESA-MAF-SYLLABUS-ED01` — объём предмета «возможности человека» [MAF][maf].
