...
**Операционные правила Part-NCO (English: non-commercial operations with other-than-complex motor-powered aircraft; español: operaciones no comerciales con aeronaves distintas de las propulsadas complejas)** применяются по виду операции и воздушному судну, а не просто потому, что пилот позднее получил лицензию [Part-FCL](../reference/glossary.md#term-part-fcl). Иными словами, Part-NCO определяется операцией/aircraft и не определяется одной лицензией. Аэродинамическая физика общая; правовой режим операции проверяется отдельно.

Экзаменационный банк [ULM](../reference/glossary.md#term-ulm) остаётся динамическим: страница [AESA](../reference/glossary.md#term-aesa), обновлённая 23.06.2026, сообщает о пересмотре вопросов под GU09 и плане ввода после лета 2026 без конкретной даты. Это не подтверждает, что действующий в день экзамена банк уже полностью GU09-aligned; кандидат проверяет `SRC-AESA-ULM-QUESTION-BANKS` непосредственно перед подготовкой/экзаменом.
...
- `SRC-AESA-ULM-QUESTION-BANKS` — dynamic transition warning, page updated 23.06.2026.
