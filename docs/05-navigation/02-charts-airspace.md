...
При последующем [LAPL(A)](../reference/glossary.md#term-lapl-a)/[PPL(A)](../reference/glossary.md#term-ppl-a) картографическая дисциплина остаётся общей. Для полёта, к которому применима [Part-NCO](../reference/glossary.md#term-part-nco), NCO.GEN.135(a)(10)/AMC1 и NCO.OP.135 относятся к доступным актуальным картам, данным и предполётной информации; применимость определяется видом эксплуатации и воздушным судном, а не самим наличием лицензии. Источник: `SRC-EASA-AIR-OPS-2026` (проверено 13.07.2026).
