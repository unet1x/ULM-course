...
Глава учит доказывать допустимость каждой загрузки самолёта [ULM](../reference/glossary.md#term-ulm), используемого в программе [MAF](../reference/glossary.md#term-maf), до запуска двигателя и повторять проверку для ожидаемой посадки. Основа испанской программы — GU09, Performance y Planificación Vuelo, pp. 21–27; связанные цели находятся на p. 33 §1.2 и p. 38 §§4.6, 4.8 (`SRC-AESA-ULM-LEARNING-OBJECTIVES-GU09-ED01`). Устойчивую арифметику объясняют FAA-H-8083-25C, pp. 10-1–10-6 (`SRC-FAA-PHAK-25C-CH10`) и FAA-H-8083-1B, pp. 5-1–5-4 и 7-1–7-8 (`SRC-FAA-WBH-1B`); американские нормы и типовые массы в Испанию не переносятся.
...
| Метка | Что изучать |
|---|---|
| [ULM — ОСНОВА][ulm] | Масса, центровка, фактическая загрузка и документы самолёта [ULM](../reference/glossary.md#term-ulm) в испанской программе [MAF](../reference/glossary.md#term-maf) |
...
Для самолёта [ULM](../reference/glossary.md#term-ulm), используемого в испанской программе [MAF](../reference/glossary.md#term-maf), начинайте с самолётного листа взвешивания, а не с 600 kg. Малый остаток полезной нагрузки означает, что округление массы пассажира, забытая сумка или неверная плотность топлива может изменить и массу, и CG. GU09 требует понимать конструкционную и эксплуатационную массу, загрузку и CG; [syllabus](../reference/glossary.md#term-syllabus) не публикует предел конкретного борта.
